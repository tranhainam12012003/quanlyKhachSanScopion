...
public class ThongTinDatPhongServices {
    @Autowired
    DonDatRepoSitoryDTO_dong donDatRepository;
...
//    }
    public List<DTOThongTinLoaiPhong>detailTheoDonDat(Integer idDonDat){
        return donDatRepository.detailDonDat(idDonDat);
    }
}
